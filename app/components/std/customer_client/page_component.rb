class Std::CustomerClient::PageComponent < Std::BasePageComponent
  ...
  private
    ...
    def collection_path(**) = helpers.std_customer_clients_path(**)
    def member_path(id, **) = helpers.std_customer_client_path(id, **)

    def master_batch_save_url
      helpers.batch_save_std_customer_clients_path
    end

    def selected_client_label
      if selected_client.present?
        "선택 고객거래처: #{selected_client}"
      else
        "고객거래처를 먼저 선택하세요."
      end
    end
    ...
    def contact_list_url_template
      "/std/customer_clients/:id/contacts.json"
    end

    def contact_batch_url_template
      "/std/customer_clients/:id/batch_save_contacts"
    end

    def workplace_list_url_template
      "/std/customer_clients/:id/workplaces.json"
    end

    def workplace_batch_url_template
      "/std/customer_clients/:id/batch_save_workplaces"
    end

    def section_map_json
      rows = AdmCodeDetail.active.where(code: "STD_CUST_BZAC_SCTN").where.not(upper_detail_code: [ nil, "" ]).ordered
    ...
    def search_fields
      [
        { field: "bzac_cd", type: "input", label: "고객거래처코드", placeholder: "고객거래처코드 검색.." },
        { field: "bzac_nm", type: "input", label: "고객거래처명", placeholder: "고객거래처명 검색.." },
        {
          field: "mngt_corp_nm",
          type: "popup",
          label: "관리법인",
        ...
        },
        {
          ...
          type: "select",
          label: "고객거래처구분그룹",
          options: common_code_options("STD_CUST_BZAC_SCTN_GRP", include_all: false),
          include_blank: false
        },
        {
          field: "bzac_sctn_cd",
          type: "select",
          label: "고객거래처구분",
          options: common_code_options("STD_CUST_BZAC_SCTN", include_all: true),
          include_blank: false
        },
    ...
    def master_columns
      [
        ...
        { field: "bzac_cd", headerName: "고객거래처코드", minWidth: 130, editable: false },
        { field: "bzac_nm", headerName: "고객거래처명", minWidth: 180, editable: false },
        {
          field: "bzac_sctn_grp_cd",
          headerName: "고객거래처구분그룹",
          minWidth: 160,
          editable: false,
          formatter: "codeLabel",
          context: { codeMap: common_code_map("STD_CUST_BZAC_SCTN_GRP") }
        },
        {
          field: "bzac_sctn_cd",
          headerName: "고객거래처구분",
          ...
          editable: false,
          formatter: "codeLabel",
          context: { codeMap: common_code_map("STD_CUST_BZAC_SCTN") }
        },
        ...
        { field: "upper_bzac_nm", headerName: "상위고객거래처명", minWidth: 180, editable: false, hide: true },
    ...
    def detail_form_data
      {
        action: "submit->resource-form#submit submit->std-customer-client-grid#preventDetailSubmit"
      }
    end

    def basic_form_fields
      [
        { field: "bzac_cd", type: "input", label: "고객거래처코드", readonly: true, target: "detailField" },
        { field: "bzac_nm", type: "input", label: "고객거래처명", required: true, maxlength: 100, target: "detailField" },
        {
          field: "mngt_corp_nm",
          type: "popup",
          label: "관리법인",
        ...
        { field: "bizman_no", type: "input", label: "사업자번호", required: true, maxlength: 10, inputmode: "numeric", target: "detailField" },
        {
          ...
          label: "고객거래처구분그룹",
          required: true,
          options: common_code_options("STD_CUST_BZAC_SCTN_GRP"),
        ...
        },
        {
          ...
          label: "고객거래처구분",
          required: true,
          options: common_code_options("STD_CUST_BZAC_SCTN"),
        ...
        },
        {
          ...
          label: "고객거래처종류",
          required: true,
          options: common_code_options("STD_CUST_BZAC_KIND"),
          target: "detailField"
        },
        {
          field: "ctry_cd",
        ...
        },
        {
          ...
          placeholder: "상위고객거래처 선택",
          target: "detailField"
        },
        { field: "rpt_bzac_cd", type: "input", label: "대표고객거래처", maxlength: 20, target: "detailField" },
    ...
    def additional_form_fields
      [
        ...
        { field: "bilg_bzac_cd", type: "input", label: "청구고객거래처", maxlength: 20, target: "detailField" },
        {
          field: "fnc_or_nm",
          type: "popup",
          label: "금융기관",
