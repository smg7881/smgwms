class Wm::SellFeeRtMng < ApplicationRecord
  self.table_name = "wm_sell_fee_rt_mngs"
  self.primary_key = "wrhs_exca_fee_rt_no"

  has_many :details, class_name: "Wm::SellFeeRtMngDtl", foreign_key: "wrhs_exca_fee_rt_no", dependent: :destroy
