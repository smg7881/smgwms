...
export default class extends BaseGridController {
  ...
  masterManagerConfig() {
    return {
      ...
      fields: {
        ...
        sell_buy_attr_nm: "trim",
        sell_dept_cd: "trimUpper",
        sell_dept_nm: "trim",
        sell_item_type: "trimUpper",
        sell_item_cd: "trimUpper",
        sell_item_nm: "trim",
        sell_unit_clas_cd: "trimUpper",
        sell_unit_cd: "trimUpper",
  ...
  async loadDetailRows(rowData) {
    ...
    try {
      const url = buildTemplateUrl(this.detailListUrlTemplateValue, { sell_fee_rt_mng_id: masterKey })
  ...
  deleteMasterRows() {
    this.deleteRows({ manager: this.masterManager, deleteLabel: "매출요율" })
  }

  addDetailRow() {
    if (!this.currentMasterRef) {
      showAlert("매출요율을 먼저 선택하세요.")
      return
    }
  ...
  deleteDetailRows() {
    this.deleteRows({ manager: this.detailManager, deleteLabel: "매출요율상세" })
  }
