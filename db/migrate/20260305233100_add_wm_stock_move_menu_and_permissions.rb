class AddWmStockMoveMenuAndPermissions < ActiveRecord::Migration[8.1]
  ...
  MENU_DEFINITION = {
    menu_cd: "WM_STOCK_MOVE",
    menu_nm: "재고관리",
    menu_url: "/wm/stock_moves",
    menu_icon: "package-search",
    tab_id: "wm-stock-moves"
  }.freeze
  ...
  private
    def ensure_wm_parent_folder!
      ...
      return "WM_GROUP" if wm_group_menu.present?

      wm_menu = MigrationAdmMenu.find_by(menu_cd: "WM")
      return "WM" if wm_menu.present?
