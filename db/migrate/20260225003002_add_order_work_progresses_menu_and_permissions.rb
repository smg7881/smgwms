class AddOrderWorkProgressesMenuAndPermissions < ActiveRecord::Migration[8.1]
  ...
  MENU_DEFINITION = {
    menu_cd: "OM_ORD_WORK_PROG",
    menu_nm: "오더별작업진행조회",
    menu_url: "/om/order_work_progresses",
    menu_icon: "clock",
    tab_id: "om-order-work-progresses"
  }.freeze
