class CreateWmZones < ActiveRecord::Migration[8.1]
  def change
    create_table :wm_zones do |t|
    ...
    add_index :wm_zones, [ :workpl_cd, :area_cd, :zone_cd ], unique: true
    add_index :wm_zones, [ :workpl_cd, :area_cd ]
    add_index :wm_zones, :zone_nm
    add_index :wm_zones, :use_yn
  end
end
