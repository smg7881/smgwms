class AddOmPreOrderReceptionMenuAndPermissions < ActiveRecord::Migration[8.1]
  ...
  MENU_DEFINITION = {
    menu_cd: "OM_PRE_ORD_RECP",
    menu_nm: "사전오더접수관리",
    menu_url: "/om/pre_order_receptions",
    menu_icon: "file-plus-2",
    tab_id: "om-pre-order-receptions"
  }.freeze
