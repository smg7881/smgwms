class CreateStdSellContractTables < ActiveRecord::Migration[8.1]
  def change
    create_table :std_sell_contracts do |t|
    ...
    add_index :std_sell_contracts, :sell_ctrt_no, unique: true
    add_index :std_sell_contracts, :bzac_cd
    add_index :std_sell_contracts, :corp_cd
    add_index :std_sell_contracts, :ctrt_sctn_cd
    add_index :std_sell_contracts, :ctrt_strt_day
    add_index :std_sell_contracts, :use_yn_cd

    create_table :std_sell_contract_settlements do |t|
      t.references :sell_contract, null: false, foreign_key: { to_table: :std_sell_contracts }
    ...
    add_index :std_sell_contract_settlements, [ :sell_contract_id, :seq_no ], unique: true, name: "index_std_sell_ctrt_stlmnt_on_contract_and_seq"
    add_index :std_sell_contract_settlements, :use_yn_cd

    create_table :std_sell_contract_change_histories do |t|
      t.references :sell_contract, null: false, foreign_key: { to_table: :std_sell_contracts }
      t.integer :seq_no, null: false
    ...
    add_index :std_sell_contract_change_histories, [ :sell_contract_id, :seq_no ], unique: true, name: "index_std_sell_ctrt_hist_on_contract_and_seq"
    add_index :std_sell_contract_change_histories, [ :sell_contract_id, :chg_date ], name: "index_std_sell_ctrt_hist_on_contract_and_date"
  end
end
