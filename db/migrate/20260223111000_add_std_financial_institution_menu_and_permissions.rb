class AddStdFinancialInstitutionMenuAndPermissions < ActiveRecord::Migration[8.1]
  ...
  MENU_DEFINITION = {
    menu_cd: "STD_FIN_ORG",
    menu_nm: "금융기관관리",
    menu_url: "/std/financial_institutions",
    menu_icon: "landmark",
    tab_id: "std-financial-institutions"
  }.freeze
  ...
  def up
    ...
    ensure_std_folder!
    ensure_financial_institution_menu!
    ensure_permissions!
  end
  ...
  private
    ...
    def ensure_financial_institution_menu!
