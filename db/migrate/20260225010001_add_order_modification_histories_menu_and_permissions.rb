class AddOrderModificationHistoriesMenuAndPermissions < ActiveRecord::Migration[8.1]
  ...
  MENU_DEFINITION = {
    menu_cd: "OM_ORD_MOD_HIST",
    menu_nm: "오더수정이력조회",
    menu_url: "/om/order_modification_histories",
    menu_icon: "history",
    tab_id: "om-order-modification-histories"
  }.freeze
