class EnsureStdWorkRoutingStepMenuPath < ActiveRecord::Migration[8.1]
  ...
  MENU_CODE = "STD_WRK_RTING_STEP".freeze
  PARENT_MENU_CODE = "STD_WORK_BASE".freeze
  ...
  private
    def ensure_menu!
      ...
      menu.menu_nm = "기준작업경로별작업단계관리"
      menu.parent_cd = PARENT_MENU_CODE
      menu.menu_url = "/std/work_routing_steps"
      menu.menu_icon = "route"
      menu.menu_type = "MENU"
      menu.use_yn = "Y"
      menu.tab_id = "std-work-routing-steps"
