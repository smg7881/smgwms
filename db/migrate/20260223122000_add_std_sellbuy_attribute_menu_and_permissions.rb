class AddStdSellbuyAttributeMenuAndPermissions < ActiveRecord::Migration[8.1]
  ...
  MENU_DEFINITION = {
    menu_cd: "STD_SELLBUY_ATTR",
    menu_nm: "매출입항목관리",
    menu_url: "/std/sellbuy_attributes",
    menu_icon: "tags",
    tab_id: "std-sellbuy-attributes"
  }.freeze
