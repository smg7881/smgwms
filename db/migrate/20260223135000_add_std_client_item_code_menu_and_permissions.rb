class AddStdClientItemCodeMenuAndPermissions < ActiveRecord::Migration[8.1]
  ...
  MENU_DEFINITION = {
    menu_cd: "STD_CLIENT_ITEM",
    menu_nm: "거래처별아이템코드관리",
    menu_url: "/std/client_item_codes",
    menu_icon: "package-search",
    tab_id: "std-client-item-codes"
  }.freeze
