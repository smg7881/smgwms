class AddOmPreOrderReceptionErrorMenuAndPermissions < ActiveRecord::Migration[8.1]
  ...
  MENU_DEFINITION = {
    menu_cd: "OM_PRE_ORD_ERR",
    menu_nm: "사전오더접수오류관리",
    menu_url: "/om/pre_order_reception_errors",
    menu_icon: "triangle-alert",
    tab_id: "om-pre-order-reception-errors"
  }.freeze
